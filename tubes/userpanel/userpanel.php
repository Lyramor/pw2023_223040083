...
<body>
  ...
  <div class="container mt-5">
    ...
    <?php if (isset($_SESSION['username'])) { ?>
      <h2>Halo <?php echo $_SESSION['username']; ?>, Selamat Datang Di Dasboard User</h2>
    <?php } else { ?>
      <h2>Selamat Datang Di Dasboard User</h2>
    <?php } ?>
          ...
          <div class="summary-kategori p-4">
            <div class="row">
              ...
              <div class="col-6 text-white">
                ...
                <p><a href="kategori_user.php" class="text-white no-decoration">Lihat Detail</a></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="summary-artikel p-4">
            <div class="row">
              ...
              <div class="col-6 text-white">
                ...
                <p><a href="artikel_user.php" class="text-white no-decoration">Lihat Detail</a></p>
              </div>
            </div>
          </div>
        </div>
